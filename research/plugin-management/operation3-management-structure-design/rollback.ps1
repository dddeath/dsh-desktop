...
$operationRelative = 'research\plugin-management\operation3-management-structure-design'
...
if (-not (Test-Path -LiteralPath $originalState)) { throw "Missing rollback source: $originalState" }
