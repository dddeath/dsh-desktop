...
`;
    ...
    function installSettingsEnhancements() {
      const groups = [
        {
          ...
          items: ["\u901a\u7528\u8bbe\u7f6e", "\u6a21\u578b", "Agent \u9884\u8bbe", "General Settings", "Models", "Agent Presets"],
        },
        {
          key: "plugins",
          order: 20,
      ...
      const updateSettingsHeading = (dialog) => {
        ...
        subtitle.textContent = zh ? group.subtitleZh : group.subtitleEn;
        effect.textContent = zh
          ? (group.key === "plugins" ? "\u63d2\u4ef6\u53d8\u66f4\u53ef\u80fd\u9700\u91cd\u542f" : "\u6309\u5404\u9879\u8bf4\u660e\u751f\u6548")
          : (group.key === "plugins" ? "Plugin changes may require restart" : "Applies as described per item");
        dialog.dataset.dshSettingsPage = group.key;
      };
